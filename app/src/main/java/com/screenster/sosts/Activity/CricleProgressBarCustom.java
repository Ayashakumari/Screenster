...
public class CricleProgressBarCustom extends View {
    ...
    protected void onDraw(Canvas canvas) {
      ...
      //  createDotInCircle(canvas,progressPaint);
        ...
        progressPaint.setColor(Color.parseColor("#D5D4D0"));

        //call create dot method
        createDotInCircle(canvas,progressPaint,progressPaint2);

    }

    private void createDotInCircle(Canvas canvas, Paint progressPaint, Paint progressPaint2) {
        ...
        for(int i = 1; i <= dotAmount; i++){
            ...
            if(i == dotPosition){
                ...
                canvas.drawCircle(x,y, bounceDotRadius, progressPaint2);
